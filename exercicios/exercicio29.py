...
Ao dicionar um partido a um político, define esse como o partido atual do político.
...
Sempre que uma candidatura for criada ou atualizada, o atributo 'ultima_atualizacacao' deve ser atualizado.
"""
