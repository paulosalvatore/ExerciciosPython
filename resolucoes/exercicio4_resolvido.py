...
print("{}/{}/{} - {}h{}'{}\"".format(data1.day, data1.month, data1.year, data1.hour, data1.minute, data1.second))
...
# O dia da semana será exibido em inteiro, onde Segunda = 0 e Domingo é 6
print("{}/{}/{} - Dia da Semana: {}".format(data2.day, data2.month, data2.year, data2.weekday()))
